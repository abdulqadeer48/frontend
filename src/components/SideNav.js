      ...
      <div className="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li className="breadcrumb-item text-sm text-dark active" aria-current="page">New User</li>
          </ol>
          <h6 className="font-weight-bolder mb-0">New User</h6>
        </nav>
        ...
        <div className="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div className="ms-md-auto pe-md-3 d-flex align-items-center">
            <div className="input-group input-group-outline">
              ...
              <input type="text" className="form-control" onfocus="focused(this)" onfocusout="defocused(this)" />
            </div>
          </div>
          <ul className="navbar-nav  justify-content-end">
            <li className="nav-item">
              <a href="javascript:;" className="nav-link text-body p-0 position-relative">
